...
void Vtb_spi_slave___024root__trace_chg_0_sub_0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY((vlSelf->__Vm_traceActivity[1U] 
        ...
        bufp->chgBit(oldp+3,(vlSelf->tb_spi_slave__DOT__load));
        bufp->chgCData(oldp+4,(vlSelf->tb_spi_slave__DOT__din),8);
        bufp->chgIData(oldp+5,(vlSelf->tb_spi_slave__DOT__spi_send_byte__Vstatic__i),32);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        bufp->chgBit(oldp+6,(vlSelf->tb_spi_slave__DOT__d_valid));
        bufp->chgCData(oldp+7,(vlSelf->tb_spi_slave__DOT__dout),8);
        bufp->chgCData(oldp+8,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_in),8);
        bufp->chgCData(oldp+9,(vlSelf->tb_spi_slave__DOT__dut__DOT__count),4);
    }
    bufp->chgBit(oldp+10,(vlSelf->tb_spi_slave__DOT__sclk));
    bufp->chgBit(oldp+11,((1U & ((IData)(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out) 
                                 >> 7U))));
    bufp->chgCData(oldp+12,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out),8);
}
