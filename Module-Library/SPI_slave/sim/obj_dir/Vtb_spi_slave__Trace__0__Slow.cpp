...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_init_sub__TOP__0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declDouble(c+22,0,"CLK_T",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::DOUBLE, false,-1);
    tracep->declDouble(c+24,0,"SCLK_T",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::DOUBLE, false,-1);
    ...
    tracep->declBit(c+6,0,"miso",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+9,0,"d_valid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+6,0,"miso",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+9,0,"d_valid",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+16,0,"shift_in",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+17,0,"bit_count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->declBus(c+18,0,"captured_data",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBit(c+19,0,"data_ready_toggle",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+7,0,"shift_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBit(c+8,0,"cs_n_prev",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+11,0,"toggle_sync1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+12,0,"toggle_sync2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+13,0,"toggle_sync3",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+14,0,"captured_sync1",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+15,0,"captured_sync2",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_const_0_sub_0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullDouble(oldp+22,(20.0));
    bufp->fullDouble(oldp+24,(1.00000000000000000e+03));
}
...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_full_0_sub_0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+6,((1U & ((IData)(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out) 
                                 >> 7U))));
    bufp->fullCData(oldp+7,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out),8);
    bufp->fullBit(oldp+8,(vlSelf->tb_spi_slave__DOT__dut__DOT__cs_n_prev));
    bufp->fullBit(oldp+9,(vlSelf->tb_spi_slave__DOT__d_valid));
    bufp->fullCData(oldp+10,(vlSelf->tb_spi_slave__DOT__dout),8);
    bufp->fullBit(oldp+11,(vlSelf->tb_spi_slave__DOT__dut__DOT__toggle_sync1));
    bufp->fullBit(oldp+12,(vlSelf->tb_spi_slave__DOT__dut__DOT__toggle_sync2));
    bufp->fullBit(oldp+13,(vlSelf->tb_spi_slave__DOT__dut__DOT__toggle_sync3));
    bufp->fullCData(oldp+14,(vlSelf->tb_spi_slave__DOT__dut__DOT__captured_sync1),8);
    bufp->fullCData(oldp+15,(vlSelf->tb_spi_slave__DOT__dut__DOT__captured_sync2),8);
    bufp->fullCData(oldp+16,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_in),8);
    bufp->fullCData(oldp+17,(vlSelf->tb_spi_slave__DOT__dut__DOT__bit_count),4);
    bufp->fullCData(oldp+18,(vlSelf->tb_spi_slave__DOT__dut__DOT__captured_data),8);
    bufp->fullBit(oldp+19,(vlSelf->tb_spi_slave__DOT__dut__DOT__data_ready_toggle));
    bufp->fullBit(oldp+20,(vlSelf->tb_spi_slave__DOT__clk));
}
