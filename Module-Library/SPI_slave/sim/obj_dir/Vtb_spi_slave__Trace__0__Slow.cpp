...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_init_sub__TOP__0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+11,0,"sclk",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+12,0,"miso",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+7,0,"d_valid",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+8,0,"dout",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declDouble(c+15,0,"T",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::DOUBLE, false,-1);
    tracep->declBus(c+6,0,"spi_send_byte__Vstatic__i",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::INTEGER, false,-1, 31,0);
    tracep->pushPrefix("dut", VerilatedTracePrefixType::SCOPE_MODULE);
    tracep->declBus(c+14,0,"WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBit(c+1,0,"rst",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBit(c+11,0,"sclk",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+12,0,"miso",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBit(c+7,0,"d_valid",-1, VerilatedTraceSigDirection::OUTPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    ...
    tracep->declBus(c+9,0,"shift_in",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+13,0,"shift_out",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 7,0);
    tracep->declBus(c+10,0,"count",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::VAR, VerilatedTraceSigType::LOGIC, false,-1, 3,0);
    tracep->popPrefix();
    tracep->popPrefix();
}
...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_const_0_sub_0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullDouble(oldp+15,(2.22199999999999989e+01));
}
...
VL_ATTR_COLD void Vtb_spi_slave___024root__trace_full_0_sub_0(Vtb_spi_slave___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelf->tb_spi_slave__DOT__load));
    bufp->fullCData(oldp+5,(vlSelf->tb_spi_slave__DOT__din),8);
    bufp->fullIData(oldp+6,(vlSelf->tb_spi_slave__DOT__spi_send_byte__Vstatic__i),32);
    bufp->fullBit(oldp+7,(vlSelf->tb_spi_slave__DOT__d_valid));
    bufp->fullCData(oldp+8,(vlSelf->tb_spi_slave__DOT__dout),8);
    bufp->fullCData(oldp+9,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_in),8);
    bufp->fullCData(oldp+10,(vlSelf->tb_spi_slave__DOT__dut__DOT__count),4);
    bufp->fullBit(oldp+11,(vlSelf->tb_spi_slave__DOT__sclk));
    bufp->fullBit(oldp+12,((1U & ((IData)(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out) 
                                  >> 7U))));
    bufp->fullCData(oldp+13,(vlSelf->tb_spi_slave__DOT__dut__DOT__shift_out),8);
}
