...
void Vtb_vga_spi___024root__trace_chg_0_sub_0(Vtb_vga_spi___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[3U])) {
        ...
        bufp->chgBit(oldp+17,(vlSelf->tb_vga_spi__DOT__DUT__DOT__sync1));
        bufp->chgBit(oldp+18,(vlSelf->tb_vga_spi__DOT__DUT__DOT__sync2));
        bufp->chgBit(oldp+19,(vlSelf->tb_vga_spi__DOT__DUT__DOT__sync3));
        bufp->chgBit(oldp+20,(vlSelf->tb_vga_spi__DOT__DUT__DOT__d_valid_sync));
        bufp->chgBit(oldp+21,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer));
        bufp->chgBit(oldp+22,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__swap_latch));
        bufp->chgSData(oldp+23,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active)
                                  ? (0x1ffU & (((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__h_count) 
                                                - (IData)(0x90U)) 
                                               >> 1U))
                                  : 0U)),9);
        bufp->chgCData(oldp+24,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active)
                                  ? (0xffU & (((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__v_count) 
                                               - (IData)(0x23U)) 
                                              >> 1U))
                                  : 0U)),8);
        bufp->chgSData(oldp+25,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active)
        ...
        bufp->chgSData(oldp+26,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active)
                                  ? (0x3ffU & ((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__v_count) 
                                               - (IData)(0x23U)))
                                  : 0U)),10);
        bufp->chgBit(oldp+27,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active));
        bufp->chgBit(oldp+28,(((0U == (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__h_count)) 
                               & (0U == (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__v_count)))));
        bufp->chgIData(oldp+29,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__addr_b),17);
        bufp->chgCData(oldp+30,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer)
                                  ? (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_b_0)
                                  : (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_b_1))),8);
        bufp->chgBit(oldp+31,(((~ (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer)) 
                               & (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__wen))));
        bufp->chgIData(oldp+32,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__addr_a_0),17);
        bufp->chgCData(oldp+33,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer)
                                  ? 0U : (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__din))),8);
        bufp->chgCData(oldp+34,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_a_0),8);
        bufp->chgCData(oldp+35,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_b_0),8);
        bufp->chgBit(oldp+36,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer) 
                               & (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__wen))));
        bufp->chgIData(oldp+37,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__addr_a_1),17);
        bufp->chgCData(oldp+38,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__curr_buffer)
                                  ? (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__din)
                                  : 0U)),8);
        bufp->chgCData(oldp+39,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_a_1),8);
        bufp->chgCData(oldp+40,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__dout_b_1),8);
        bufp->chgCData(oldp+41,(((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__vga_active)
                                  ? 0xfU : 0U)),4);
        bufp->chgBit(oldp+42,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__vga_en));
        bufp->chgBit(oldp+43,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__clk_div_count));
        bufp->chgSData(oldp+44,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__h_count),10);
        bufp->chgSData(oldp+45,(vlSelf->tb_vga_spi__DOT__DUT__DOT__VGA__DOT__VGA__DOT__v_count),10);
    }
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[4U])) {
        bufp->chgBit(oldp+46,(vlSelf->tb_vga_spi__DOT__DUT__DOT__d_valid_spi));
        bufp->chgCData(oldp+47,(vlSelf->tb_vga_spi__DOT__DUT__DOT__dout_spi),8);
        bufp->chgCData(oldp+48,(vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_in),8);
        bufp->chgCData(oldp+49,(vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__count),4);
    }
    bufp->chgBit(oldp+50,(vlSelf->tb_vga_spi__DOT__clk));
    bufp->chgBit(oldp+51,((1U & ((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out) 
                                 >> 7U))));
    bufp->chgBit(oldp+52,(vlSelf->tb_vga_spi__DOT__DUT__DOT__toggle_spi));
