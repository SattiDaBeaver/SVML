...
VL_INLINE_OPT void Vtb_vga_spi___024root___nba_sequent__TOP__0(Vtb_vga_spi___024root* vlSelf) {
    ...
    if (vlSelf->tb_vga_spi__DOT__rst) {
        ...
        vlSelf->tb_vga_spi__DOT__DUT__DOT__wen = 0U;
        vlSelf->tb_vga_spi__DOT__DUT__DOT__swap_buf = 0U;
        if (vlSelf->tb_vga_spi__DOT__DUT__DOT__d_valid_spi) {
...
VL_INLINE_OPT void Vtb_vga_spi___024root___nba_sequent__TOP__2(Vtb_vga_spi___024root* vlSelf) {
    ...
    // Init
    CData/*7:0*/ __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out;
    __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out = 0;
    // Body
    __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out 
        = vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out;
    if (vlSelf->tb_vga_spi__DOT__rst) {
        __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out = 0U;
    } else if (((~ (IData)(vlSelf->tb_vga_spi__DOT__cs_n)) 
                & (IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__cs_n_prev))) {
        __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out = 0U;
    } else if ((1U & (~ (IData)(vlSelf->tb_vga_spi__DOT__cs_n)))) {
        __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out 
    ...
    vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out 
        = __Vdly__tb_vga_spi__DOT__DUT__DOT__SPI__DOT__shift_out;
    vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__cs_n_prev 
        = ((IData)(vlSelf->tb_vga_spi__DOT__rst) || (IData)(vlSelf->tb_vga_spi__DOT__cs_n));
}
