...
VL_ATTR_COLD void Vtb_vga_spi___024root___dump_triggers__act(Vtb_vga_spi___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(posedge tb_vga_spi.DUT.d_valid_spi or posedge tb_vga_spi.rst)\n");
    }
    if ((2ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge tb_vga_spi.clk)\n");
    }
    if ((4ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 2 is active: @(posedge tb_vga_spi.cs_n or posedge tb_vga_spi.rst or posedge tb_vga_spi.sclk)\n");
    }
    if ((8ULL & vlSelf->__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 3 is active: @(posedge tb_vga_spi.rst or negedge tb_vga_spi.sclk)\n");
    }
...
VL_ATTR_COLD void Vtb_vga_spi___024root___dump_triggers__nba(Vtb_vga_spi___024root* vlSelf) {
    ...
    if ((1ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(posedge tb_vga_spi.DUT.d_valid_spi or posedge tb_vga_spi.rst)\n");
    }
    if ((2ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge tb_vga_spi.clk)\n");
    }
    if ((4ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 2 is active: @(posedge tb_vga_spi.cs_n or posedge tb_vga_spi.rst or posedge tb_vga_spi.sclk)\n");
    }
    if ((8ULL & vlSelf->__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 3 is active: @(posedge tb_vga_spi.rst or negedge tb_vga_spi.sclk)\n");
    }
...
VL_ATTR_COLD void Vtb_vga_spi___024root___ctor_var_reset(Vtb_vga_spi___024root* vlSelf) {
    ...
    vlSelf->tb_vga_spi__DOT__DUT__DOT__din_spi = VL_RAND_RESET_I(8);
    ...
    vlSelf->tb_vga_spi__DOT__DUT__DOT__toggle_spi = VL_RAND_RESET_I(1);
    vlSelf->tb_vga_spi__DOT__DUT__DOT__sync1 = VL_RAND_RESET_I(1);
    vlSelf->tb_vga_spi__DOT__DUT__DOT__sync2 = VL_RAND_RESET_I(1);
    vlSelf->tb_vga_spi__DOT__DUT__DOT__sync3 = VL_RAND_RESET_I(1);
    vlSelf->tb_vga_spi__DOT__DUT__DOT__d_valid_sync = VL_RAND_RESET_I(1);
    ...
    vlSelf->tb_vga_spi__DOT__DUT__DOT__SPI__DOT__count = VL_RAND_RESET_I(4);
    vlSelf->__Vdly__tb_vga_spi__DOT__DUT__DOT__toggle_spi = VL_RAND_RESET_I(1);
    vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__DUT__DOT__d_valid_spi__0 = VL_RAND_RESET_I(1);
