...
void Vtb_vga_spi___024root___eval_triggers__act(Vtb_vga_spi___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, (((IData)(vlSelf->tb_vga_spi__DOT__DUT__DOT__d_valid_spi) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__DUT__DOT__d_valid_spi__0))) 
                                     | ((IData)(vlSelf->tb_vga_spi__DOT__rst) 
                                        & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__rst__0)))));
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->tb_vga_spi__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__clk__0))));
    vlSelf->__VactTriggered.set(2U, ((((IData)(vlSelf->tb_vga_spi__DOT__cs_n) 
    ...
    vlSelf->__VactTriggered.set(3U, (((IData)(vlSelf->tb_vga_spi__DOT__rst) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__rst__0))) 
                                     | ((~ (IData)(vlSelf->tb_vga_spi__DOT__sclk)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_vga_spi__DOT__sclk__0))));
